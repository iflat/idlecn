...
class EditorWindow(object):
    ...
    def __init__(self, flist=None, filename=None, key=None, root=None):
        ...
        try:
            ...
            sys.ps1 = '>>> '
        self.menubar = Menu(root,font=(font,'10'))
    ...
    def createmenubar(self):
        ...
        for name, label in self.menu_specs:
            ...
            menudict[name] = menu = Menu(mbar, name=name, tearoff=0, font=(font,'10'))
        ...
        self.menudict['file'].insert_cascade(3, label='最近打开文件',
                                             underline=0,
    ...
    rmenu_specs = [
        ...
        ("关闭窗口", "<<close-window>>", None), # Example
    ]
    ...
    def about_dialog(self, event=None):
        ...
        help_about.AboutDialog(self.top,'关于IDLE')
    ...
    def python_docs(self, event=None):
        if sys.platform[:3] == 'win':
            try:
                ...
                tkMessageBox.showerror(title='文档打开失败',
    ...
    def goto_line_event(self, event):
        text = self.text
        lineno = tkSimpleDialog.askinteger("转到",
                "输入转到的行号:",parent=text)
        if lineno is None:
            return "break"
        if lineno <= 0:
    ...
    def update_recent_files_list(self, new_file=None):
        ...
        try:
            ...
            if not getattr(self.root, "recentfilelist_error_displayed", False):
                ...
                tkMessageBox.showwarning(title='IDLE 警告',
                    message="未能更新文件菜单中的最近打开文件列表. "
                            "操作系统返回:\n%s\n"
                            "选择 OK IDLE将返回，但没有完成文件列表更新操作."
...
### begin autoindent code ###  (configuration was moved to beginning of class)
    ...
    def toggle_tabs_event(self, event):
        if self.askyesno(
              "Tab键",
              "Tabs键状态切换为 " + ("开", "关")[self.usetabs] +
              "?\n缩进宽度 " +
              ("默认", "值为")[self.usetabs] + " 8." +
              "\n 注意: 一个Tab键宽度总为 8 列",
              parent=self.text):
