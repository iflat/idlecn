...
class ConfigDialog(Toplevel):
    ...
    def CreateWidgets(self):
        self.tabPages = TabbedPageSet(self,
                page_names=['字体/Tabs', '语法高亮', '快捷键', '常规',
                            '扩展'])
    ...
    def CreatePageFontTab(self):
        ...
        ##widget creation
        #body frame
        frame = self.tabPages.pages['字体/Tabs'].frame
        #body section frames
        frameFont = LabelFrame(
                frame, borderwidth=2, relief=GROOVE, text=' 编辑字体 ')
        frameIndent = LabelFrame(
                frame, borderwidth=2, relief=GROOVE, text=' 缩进宽度 ')
        #frameFont
        frameFontName = Frame(frameFont)
        frameFontParam = Frame(frameFont)
        labelFontNameTitle = Label(
                frameFontName, justify=LEFT, text='字体列表 :')
        ...
        labelFontSizeTitle = Label(frameFontParam, text='字体大小 :')
        ...
        checkFontBold = Checkbutton(
                ...
                offvalue=0, text='加粗', command=self.SetFontSample)
    ...
    def CreatePageHighlight(self):
        ...
        ##widget creation
        #body frame
        frame = self.tabPages.pages['语法高亮'].frame
        #body section frames
    ...
    def CreatePageKeys(self):
        ...
        ##widget creation
        #body frame
        frame = self.tabPages.pages['快捷键'].frame
        #body section frames
        frameCustom = LabelFrame(
                frame, borderwidth=2, relief=GROOVE,
                text=' 自定义快捷键 ')
        frameKeySets = LabelFrame(
                frame, borderwidth=2, relief=GROOVE, text=' 快捷键设置 ')
        #frameCustom
        frameTarget = Frame(frameCustom)
        labelTargetTitle = Label(frameTarget, text='操作 - 快捷键(s)')
    ...
    def CreatePageGeneral(self):
        ...
        #widget creation
        #body
        frame = self.tabPages.pages['常规'].frame
        #body section frames
        ...
        frameHelp = LabelFrame(frame, borderwidth=2, relief=GROOVE,
                               text=' 自定义帮助 ')
        #frameRun
        labelRunChoiceTitle = Label(frameRun, text='启动为')
        ...
        self.radioStartupShell = Radiobutton(
                ...
                text='交互模式')
        #frameSave
        labelRunSaveTitle = Label(frameSave, text='运行时提示 (F5)  ')
        ...
        labelWinSizeTitle = Label(
                frameWinSize, text='初始窗口大小  (以字符为单位)')
        labelWinWidthTitle = Label(frameWinSize, text='宽度')
        self.entryWinWidth = Entry(
                frameWinSize, textvariable=self.winWidth, width=3)
        labelWinHeightTitle = Label(frameWinSize, text='高度')
    ...
    def VarChanged_builtinTheme(self, *params):
        ...
        if value not in oldthemes:
            ...
            self.new_custom_theme.config(text='定义新的主题, 查看帮助菜单',
                                         fg='#500000')
        else:
    ...
    def VarChanged_builtinKeys(self, *params):
        ...
        if value not in oldkeys:
            ...
            self.new_custom_keys.config(text='定义新的快捷键, 查看帮助菜单',
                                        fg='#500000')
        else:
    ...
    def GetNewKeys(self):
        ...
        newKeys = GetKeysDialog(self, '定义新快捷键', bindName,
                currentKeySequences).result
        if newKeys: #new keys were specified
            if self.keysAreBuiltin.get(): #current key set is a built-in
                message = ('你的修改将保存为新的快捷键自定义配置.'
                           ' 为你的自定义配置设置一个名称.')
    ...
    def GetNewKeysName(self, message):
        ...
        newKeySet = SectionName(
                self, '新的自定义快捷键', message, usedNames).result
        return newKeySet

    def SaveAsNewKeySet(self):
        newKeysName = self.GetNewKeysName('自定义快捷键配置名称:')
        if newKeysName:
    ...
    def DeleteCustomKeys(self):
        ...
        delmsg = '你确定要删除该快捷键配置 %r 吗?'
        if not tkMessageBox.askyesno(
                '删除配置',  delmsg % keySetName, parent=self):
            return
        ...
        if not itemList:
            ...
            self.optMenuKeysCustom.SetMenu(itemList, '- 没有快捷键自定义配置 -')
        else:
    ...
    def DeleteCustomTheme(self):
        ...
        delmsg = '你确定要删除该主题配置 %r 吗?'
        if not tkMessageBox.askyesno(
                '删除主题',  delmsg % themeName, parent=self):
            return
        self.DeactivateCurrentConfig()
        ...
        if not itemList:
            ...
            self.optMenuThemeCustom.SetMenu(itemList, '- 没有自定义主题 -')
        else:
    ...
    def GetColour(self):
        ...
        rgbTuplet, colourString = tkColorChooser.askcolor(
                parent=self, title='选择颜色 : '+target,
                initialcolor=prevColour)
        if colourString and (colourString != prevColour):
            #user didn't cancel, and they chose a new colour
            if self.themeIsBuiltin.get():  #current theme is a built-in
                message = ('你的修改将会被保存为新的配置主题. '
                           '请在下边输入你的自定义主题名称.')
    ...
    def GetNewThemeName(self, message):
        ...
        newTheme = SectionName(
                self, '新的自定义主题', message, usedNames).result
        return newTheme

    def SaveAsNewTheme(self):
        newThemeName = self.GetNewThemeName('新的主题名称:')
        if newThemeName:
    ...
    def HelpListItemAdd(self):
        helpSource = HelpSource(self, '新的帮助资源',
                                ).result
        if helpSource:
    ...
    def LoadKeyCfg(self):
        ...
        if self.keysAreBuiltin.get(): #default theme selected
            ...
            if not itemList:
                self.radioKeysCustom.config(state=DISABLED)
                self.customKeys.set('- 没有快捷键自定义配置 -')
            else:
                self.optMenuKeysCustom.SetMenu(itemList, itemList[0])
    ...
    def Help(self):
        ...
        view_text(self, title='IDLE 配置帮助',
    ...
    def CreatePageExtensions(self):
        ...
        """
        parent = self.parent
        frame = self.tabPages.pages['扩展'].frame
